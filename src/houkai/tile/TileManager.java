...
public class TileManager {
    ...
    public void getTileImage(){
            ...
            // ===== Corner Wall (1) =====
            setup(8,"corner_left_down",true);
            setup(9,"corner_right_down",true);
            setup(10,"corner_left_top",true);
            setup(11,"corner_right_top",true);
            // ===== Corner Wall (2) =====
            setup(12,"c_down_left",true);
            setup(13,"c_down_right",true);
            setup(14,"c_top_left",true);
            setup(15,"c_top_right",true);
            // ===== Pilar =====
            setup(16,"pillar_top",true);
            setup(17,"pillar_down",true);
            setup(18,"pillar_left",true);
            setup(19,"pillar_right",true);
             // ===== Underground (1) =====
            setup(20,"w_top",true);
            setup(21,"w_left",true);
            setup(22,"w_right",true);
             // ===== Underground (2) =====
            setup(23,"w_top_left_corner",true);
            setup(24,"w_top_right_corner",true);
            setup(25,"w_down_left_corner",true);
            setup(26,"w_down_right_corner",true);
            // ===== Underground (3) =====
            setup(27,"w_mid_left",true);
            setup(28,"w_mid_right",true);
            setup(29,"w_mid_left-2",true);
            setup(30,"w_mid_right-2",true);
            // ===== Ladder =====
